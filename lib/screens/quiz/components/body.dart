...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Questions>>(
      future: widget.mode == 'multiplayer'
          ? questionController.fetchPremiumQuestions()
          : questionController.fetchBasicQuestions(),
                    ...
                    Expanded(
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) => QuestionCard(
                            mode: widget.mode,player: widget.player, question: snapshot.data![index],roomId: widget.roomId,),
                      ),
                    ),
                  ],
                ),
